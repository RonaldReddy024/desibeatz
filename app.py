...
def home():
    ...
    # The welcome message block is centered horizontally but its text is left-aligned in white,
    # using the Proxima Nova font.
    home_html = """
    <!DOCTYPE html>
    <html lang="en">
    <head>
      ...
      <style>
        ...
        .video-card video {
          ...
          border: none;
          background: #000;
          /* Add playsinline attribute to help mobile playback */
        }
        .video-info {
          margin-top: 5px;
          font-size: 0.9em;
...
def livestream():
    if request.method == 'POST':
        ...
        # For simulation, create a dummy video record
          ...
          if (toggleBtn.innerText === "Start Livestream Preview") {
            if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
              try {
                ...
                toggleBtn.innerText = "Stop Livestream Preview";
              } catch (error) {
